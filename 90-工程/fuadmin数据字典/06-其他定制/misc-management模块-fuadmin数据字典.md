---
title: misc-management模块-fuadmin数据字典
created: 2026-07-23
updated: 2026-07-23
type: reference
domain: 工程
...
### generator_management_area_allocation（约 28 行）
...
| regional_plan | varchar(255) | Y | - | - | 计划值[推断] | mid |
| region | longtext | Y | - | - | 待确认 | low |
