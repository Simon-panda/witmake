---
title: misc-ticket模块-fuadmin数据字典
created: 2026-07-23
updated: 2026-07-23
type: reference
domain: 工程
...
| sort | int | Y | - | - | 排序号 | high |
| signature | json | Y | - | - | 签名[推断] | mid |
| handle_feedback | longtext | Y | - | - | 待确认 | low |
| measure | longtext | Y | - | - | 待确认 | low |
| info | longtext | Y | - | - | 待确认 | low |
| describe | longtext | Y | - | - | 描述[推断] | mid |
| date_time | datetime | Y | - | - | 时间[推断] | high |
| work_order | varchar(100) | Y | - | - | 文本字段[推断-待确认] | low |
| tracking_card | varchar(100) | Y | - | - | 文本字段[推断-待确认] | low |
| job_code | varchar(100) | Y | - | - | 编号/代码[推断] | mid |
| name | varchar(100) | Y | - | - | 名称[推断] | high |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |
| ticket_type | int | Y | - | - | 类型[推断] | mid |
| related_photos | json | Y | - | - | 图片路径[推断] | mid |
| is_end | tinyint(1) | Y | - | - | 标志位（布尔）[推断] | mid |
| code | varchar(100) | Y | - | - | 编号/代码[推断] | mid |
| cc_send | json | Y | - | - | 待确认 | low |
| is_audit | int | Y | - | - | 标志位（布尔）[推断] | mid |
| audit_name | varchar(30) | Y | - | - | 名称[推断] | high |
