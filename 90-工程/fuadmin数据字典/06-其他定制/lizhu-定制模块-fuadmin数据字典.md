...
### generator_lizhu_count_data（约 457 行）
...
| sort | int | Y | - | - | 排序号 | high |
| create_date | datetime(6) | Y | - | - | 日期[推断] | high |
| RIGHT_GS62H | int | Y | - | - | 数值字段[推断-待确认] | low |
| RIGHT_GS62 | int | Y | - | - | 数值字段[推断-待确认] | low |
| right_gs61h | int | Y | - | - | 数值字段[推断-待确认] | low |
| right_gs61 | int | Y | - | - | 数值字段[推断-待确认] | low |
| left_gs62h | int | Y | - | - | 数值字段[推断-待确认] | low |
| left_gs62 | int | Y | - | - | 数值字段[推断-待确认] | low |
| left_gs61h | int | Y | - | - | 数值字段[推断-待确认] | low |
| left_gs61 | int | Y | - | - | 数值字段[推断-待确认] | low |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |
| _MASK_TO_V2 | bigint | Y | MUL | - | 数值字段[推断-待确认] | low |

### generator_lizhu_error_data（约 251 行）
业务定义: 见同域总览或相关主模块 ｜ 表注释: -
...
| create_date | datetime(6) | Y | - | - | 日期[推断] | high |
| model_tool_type | varchar(255) | Y | - | - | 类型[推断] | mid |
| curr_tool_type | varchar(255) | Y | - | - | 类型[推断] | mid |
| direction | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |
| _MASK_TO_V2 | bigint | Y | MUL | - | 数值字段[推断-待确认] | low |

### generator_lizhu_robot_data（约 171244 行）
业务定义: 见同域总览或相关主模块 ｜ 表注释: -
...
| direction | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| create_date | datetime(6) | Y | - | - | 日期[推断] | high |
| state | varchar(255) | Y | - | - | 状态（枚举值待确认）[推断] | mid |
| tool_type | varchar(255) | Y | - | - | 类型[推断] | mid |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |
| _MASK_TO_V2 | bigint | Y | MUL | - | 数值字段[推断-待确认] | low |
