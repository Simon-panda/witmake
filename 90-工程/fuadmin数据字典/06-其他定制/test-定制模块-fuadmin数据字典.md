...
| sort | int | Y | - | - | 排序号 | high |
| icon | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| sequence | decimal(13,4) | Y | - | - | 数值（小数）[推断-待确认] | low |
| code | varchar(255) | Y | - | - | 编号/代码[推断] | mid |
| name | varchar(255) | Y | - | - | 名称[推断] | high |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |

### generator_test_demo（约 0 行）
业务定义: （待补充） ｜ 表注释: -
...
| create_datetime | datetime(6) | Y | - | - | 创建时间 | high |
| sort | int | Y | - | - | 排序号 | high |
| des | longtext | Y | - | - | 待确认 | low |
| code | decimal(13,4) | Y | - | - | 编号/代码[推断] | mid |
| name | varchar(255) | Y | - | - | 名称[推断] | high |
| creator_id | bigint | Y | MUL | - | 创建人ID → system_users.id | high |
