---
title: misc-alarm模块-fuadmin数据字典
created: 2026-07-23
updated: 2026-07-23
type: reference
domain: 工程
...
| sort | int | Y | - | - | 排序号 | high |
| push_status | varchar(255) | Y | - | - | 状态（枚举值待确认）[推断] | mid |
| priority | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
