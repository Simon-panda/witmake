---
title: misc-commentsmessage模块-fuadmin数据字典
created: 2026-07-23
updated: 2026-07-23
type: reference
domain: 工程
...
# commentsmessage模块 · fuadmin 数据字典
...
### generator_commentsmessage（约 188 行）
业务定义: （待补充） ｜ 表注释: -
...
| odd_numbers | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| parentId | int | Y | - | - | 数值字段[推断-待确认] | low |
| postDate | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| receiverId | int | Y | - | - | 数值字段[推断-待确认] | low |
| senderId | int | Y | - | - | 数值字段[推断-待确认] | low |
| senderName | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| text | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
| sort | int | Y | - | - | 排序号 | high |
| receiverName | varchar(255) | Y | - | - | 文本字段[推断-待确认] | low |
