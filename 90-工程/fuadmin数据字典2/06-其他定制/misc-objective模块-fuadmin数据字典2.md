---
title: misc-objective模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-objective]
---

# misc-objective模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 1 | 字段: 9 | 代码锚定: 9(100%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-objective模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `generator_objective` | 检查对象（巡检对象字典） | 6 | 💻 |

---

### generator_objective
**定义**：检查对象（巡检对象字典） ｜ **流角色**：巡检基础数据 ｜ **代码**：`generator/objective/model.py` ｜ **行数(估)**：6
