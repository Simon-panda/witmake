---
title: misc-definition模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-definition]
---

# misc-definition模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 1 | 字段: 12 | 代码锚定: 12(100%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-definition模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `generator_definition_five_s` | 5S定义（5S管理目的与项目说明） | 9 | 💻 |

---

### generator_definition_five_s
**定义**：5S定义（5S管理目的与项目说明） ｜ **流角色**：5S基础定义 ｜ **代码**：`generator/definition_five_s/model.py` ｜ **行数(估)**：9
