---
title: misc-go模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-go]
---

# misc-go模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 2 | 字段: 21 | 代码锚定: 21(100%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-go模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `go_view_data` | GoView大屏数据内容 | 0 | 💻 |
| `go_view_project` | GoView大屏项目配置 | 0 | 💻 |

---

### go_view_data
**定义**：GoView大屏数据内容 ｜ **流角色**：可视化大屏 ｜ **代码**：`go_view/go_view_data/model.py` ｜ **行数(估)**：0
...
| `sort` | int | Y | - | 显示排序 | ✅📦 |  |
| `content` | longtext | Y | - | content | ✅ |  |
| `creator_id` | bigint | Y | MUL | 创建人；→system_users(软) | ✅🔗📦 | →system_users(软) |

### go_view_project
**定义**：GoView大屏项目配置 ｜ **流角色**：可视化大屏 ｜ **代码**：`go_view/go_view_project/model.py` ｜ **行数(估)**：0
...
| `state` | int | Y | - | state | ✅ |  |
| `project_name` | varchar(255) | Y | - | project_name | ✅ |  |
| `content` | longtext | Y | - | content | ✅ |  |
| `creator_id` | bigint | Y | MUL | 创建人；→system_users(软) | ✅🔗📦 | →system_users(软) |
