---
title: misc-demo模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-demo]
---

# misc-demo模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 1 | 字段: 11 | 代码锚定: 0(0%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-demo模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `demo` | 演示示例表（脚手架样例，无业务数据） | 0 | 🔍 |

---

### demo
**定义**：演示示例表（脚手架样例，无业务数据） ｜ **流角色**：样例/开发脚手架 ｜ **行数(估)**：0
...
| `sort` | int | Y | - | [推断] 显示排序 | 🔍 |  |
| `name` | varchar(64) | N | - | [推断] 名称 | 🔍 |  |
| `code` | varchar(32) | N | - | [推断] 编码 | 🔍 |  |
| `status` | varchar(64) | N | - | [推断] 状态 | 🔍 |  |
| `creator_id` | bigint | Y | MUL | [推断] 创建人ID（关联system_users） | 🔍 |  |
