---
title: misc-total模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-total]
---

# misc-total模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 1 | 字段: 15 | 代码锚定: 13(87%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-total模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `generator_total_power` | 泰峰总电量（分钟级能耗采集） | 738910 | 💻 |

---

### generator_total_power
**定义**：泰峰总电量（分钟级能耗采集） ｜ **流角色**：能耗数据采集 ｜ **代码**：`generator/total_power/model.py` ｜ **行数(估)**：738910
