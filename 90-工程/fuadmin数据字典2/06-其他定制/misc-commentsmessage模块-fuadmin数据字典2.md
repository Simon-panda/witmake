---
title: misc-commentsmessage模块-fuadmin数据字典2
created: 2026-07-24
updated: 2026-07-24
type: reference
domain: 06-其他定制
tags: [工程, 数据字典2, 代码实证, misc-commentsmessage]
---

# misc-commentsmessage模块 · fuadmin 数据字典2（代码实证版）
> 域: 06-其他定制 | 表数: 1 | 字段: 16 | 代码锚定: 16(100%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/06-其他定制/misc-commentsmessage模块-fuadmin数据字典]]
...
| 表 | 定义 | 行数(估) | 锚点 |
|---|---|---|---|
| `generator_commentsmessage` | 留言（单据评论/站内消息回复） | 188 | 💻 |

---

### generator_commentsmessage
**定义**：留言（单据评论/站内消息回复） ｜ **流角色**：单据协同沟通 ｜ **代码**：`generator/commentsmessage/model.py` ｜ **行数(估)**：188
