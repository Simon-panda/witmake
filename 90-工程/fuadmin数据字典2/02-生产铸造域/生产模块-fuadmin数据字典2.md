...
> 域: 02-生产铸造域 | 表数: 3 | 字段: 58 | 代码锚定: 57(98%) | 生成: 2026-07-24 | 上游: [[fuadmin数据字典2总览]] | 旧版: [[90-工程/fuadmin数据字典/02-生产铸造域/生产模块-fuadmin数据字典]]
...
| `generator_production_tracking` | 生产跟踪单（0行） | 0 | 💻 |
...
**定义**：生产跟踪单（0行） ｜ **代码**：`generator/production_tracking/model.py` ｜ **行数(估)**：0
