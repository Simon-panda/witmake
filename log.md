...
## [2026-08-09] create | IT小组半年工作计划书与岗位职责考核办法（V1.0）

Simon 8-9 部署 IT 小组半年核心工作。先按 Simon 纠正的方法查 fuadmin 日报实证（2025-04-07~2026-07-20，快照止 7-20）：苏杨376篇(云系统全栈+运维,7-17已自行启动跟踪单模块)、李强367篇(AI/Agent词频294,视觉绝对主力)、谢宇航352篇(刀具120+网络100,7-10后日报中断待核实)、郑翔翥381篇(采购/付款/退货300,需交接转型Agent配置+skill)。据此编排：四工作线(W1跟踪单/W2 AI视觉与主动智能层三入口/W3 QM后期/W4刀具管理)、6人岗位职责(含李强不做业务分析边界、陈学良试用期路径)、月度百分制考核(S1里程碑50+S2质量30+S3过程合规20,数据源=日报表+验收单,结果应用对齐V1.1系数)。待确认5项(跟踪单范围/F1指标/交接人/谢宇航中断/是否拆分宣贯)。已入 10-工作/制度文件/，index.md 已同步。

## [2026-08-09] update | IT小组计划书 V1.0→V1.1（Simon三点修订）

①W1跟踪单=所有产品、8月完全收口、8-10周一试点（原9-11月节奏作废，写入降级方案触发线：8-21试点覆盖<95%则先机加产品其余顺延，Simon裁决）；②郑翔翥付款申请不交接、8-10上线使用，Agent配置/skill并行（"郑祥柱"=系统档案郑翔翥22402）；③谢宇航网络工作=四厂VPN热备份基本完成、8月底确认稳定性+数据库互备核查，9月起转刀具系统升级三件套（U1边缘设备/云上程序、U2对刀仪自动读取、U3机床刀补系统-赵伟伟主导入组）；谢宇航日报中断确认=未写，纳入S3口径。剩余待确认3项：F1准确率目标/U3验证产线/是否拆分宣贯。index.md已同步。

## [2026-08-09] update | IT小组计划书 V1.1→V1.2（Simon Obsidian修订+Woker统一上下文）

Simon在Obsidian直接改排期：W2环境8-15/三入口8-30/权限试运行9-01~10-30；W3全面提前（分析测试8-10~8-15/应用8-16~9-15/培训9-16~10-15/互联10-01~10-19）；W4新增数据库冷备份（9-01~9-09智机IT间备份服务器+UPS室外）、U1提前8-10~8-25、U2加赵伟伟共责9-15~9-30、U3定产线=缸体机加线3线9-01~10-01、新增U4刀具入库出库影像检查（戴嘉龙+李红梅8-10~10-01，长度/直径/造型检测+域外模型图像分析）。定调：主线=刀具管理系统升级，其余各线主体9月前完成。Woker统一：总节奏（8月冲刺收口+9-10月刀具主攻+10月底首期验收+2027-02总验收）、删W3"跟踪单收口后启动"矛盾、加苏杨8月双线负荷提示（QM侧李强为主）、修正笔误（9~09→9-09、10-01-10-19→10-01~10-19、戴佳龙→戴嘉龙）、职责表+考核锚点全同步、待确认收敛为2项（F1准确率/拆分宣贯）。index.md已同步。

## [2026-08-09] update | IT小组三件套拆分宣贯（V1.3）

Simon两点决定：①F1图纸识别取消≥95%硬性目标（"很难实现"）→改"首版关键尺寸100%人工复核兜底+首月实测建基线+3个月后按实测数据定正式目标"；②拆三份文件宣贯。已建：IT小组半年工作计划书.md（四工作线+双节点验收）/IT小组岗位职责.md（7人+2协同+协作铁律含撞车优先级W1>W4>W3）/IT小组考核评估表.md（S1里程碑50+S2质量30+S3合规20+结果应用），原合并文件转母版/索引页（保留V1.0-V1.3修订记录）。index.md已同步为三条入口。

## [2026-08-09] update | IT小组三件套 V1.4（付磊建入组+团队日报全景）

Simon增补付磊建为机械组长（M1：刀具系统/刀具柜机械设计安装调试+刀具视觉系统机械设计）。日报实证扩展至全团队：付磊建364篇(机械设计/安装/调试261)、赵伟伟367篇(设备341)、李红梅376篇(视觉342/设备323)、戴嘉龙109篇(2026-03起,视觉94)；邱桂浩确认无日报账号。团队=核心8人+协同2人,有账号者累计2692篇,覆盖机械×电气×视觉×IT软件×基建×质量完整能力链。三文件已同步：计划书W4加M1行、岗位职责加"团队全景"+付磊建行+跨小组接口惯例(24h升级)、考核表加付磊建锚点(M1配套8-25首套安装/10-01收口/一次通过率100%)。

## [2026-08-09] create | IT小组开工对照清单-20260810

Simon 要求出 8-10 周一开工清单。四开工点（跟踪单试点/付款申请上线/QM分析测试/U1+M1+U4开工）+晨会三拍板（试点线选定/QM预算帽上调$20周/谢宇航日报恢复）+全组纪律5条（含S3周五复核口径：导库恢复前苏杨每周五导出日报提交率）。已入 10-工作/制度文件/。
...
## [2026-08-23] create | 智机会议纪要全量入库（晨会107+周会17，共124页）

Simon提供`F:\智机晨会纪要`（2026年晨例会.zip+2026周会.zip+单独8.21 docx，共159份文件）。处理：①zip为GBK文件名，Python cp437→gbk还原解压；②按会议日期归并为124场（33场存在结构化详版+简版双格式，非重复内容，合并单页：最长版正文、其余作"附"节，全量保留）；③3.9/3.12/3.13三场原始载体为PPT，python-pptx全文提取（3.12 PPT作当日附录）；④6.27标题虽为"晨例会纪要"，实为周六10:00郑总参加扩大会议，按公司归档归周会。产出：`10-工作/会议纪要/{晨会,周会}/YYYY-MM/智机X会纪要-YYYY-MM-DD.md`（frontmatter五要素+前后场导航wikilink）+ `智机会议纪要-总索引.md`（按月表格）。原始文件未复制进vault，各页参考来源节标注F盘原文件名。index.md已同步。

## [2026-08-23] update | 智机会议纪要入库——文件名日期实证纠偏（最终：晨会105+周会18=123页）

入库后全量交叉校验159份文件的"文件名日期 vs 正文会议时间"，发现7处不一致并逐份与相邻日期纪要内容比对：①智机·3.9晨例会纪要.pptx 正文为3.7周六周例会→改归周会2026-03-07（成首场周会），删除晨会3.9页；②智机2026.4.16晨例会纪要.docx 与4.17纪要96%内容相同→同一场会议误存副本，并入4.17页附录，删除4.16独立页；③6.2/6.11/6.30/7.23/8.11五份与邻日内容仅5-12%重合→确认是沿用前日模板忘改"会议时间"，页面保留并加口径注释。总索引重建，index.md同步。最终：晨会105场（03-12起）+周会18场（03-07起）=123页+1总索引。
